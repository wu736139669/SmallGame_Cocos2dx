...
#ifndef __OnceAgain__CCScrollviewSimple__
#define __OnceAgain__CCScrollviewSimple__
#include "cocos2d.h"
#include "cocos-ext.h"
USING_NS_CC;
USING_NS_CC_EXT;
...
class CCScrollviewSimple;
/**
 *  @js NA
 *  @lua NA
 */
class CCScrollViewSimpleDelegate
{
public:
    virtual ~CCScrollViewSimpleDelegate() {}
    virtual void scrollViewDidScroll(CCScrollviewSimple* view) = 0;
    virtual void scrollViewDidZoom(CCScrollviewSimple* view) = 0;
};
class CCScrollviewSimple : public CCLayer
{
public:
    /**
     *  @js ctor
     ...
     */
    static CCScrollviewSimple* create(CCSize size, CCNode* container = NULL);
     ...
     * @return autoreleased scroll view object
     */
    static CCScrollviewSimple* create();
    ...
    CCScrollViewSimpleDelegate* getDelegate() { return m_pDelegate; }
    void setDelegate(CCScrollViewSimpleDelegate* pDelegate) { m_pDelegate = pDelegate; }
...
protected:
     ...
     */
    CCScrollViewSimpleDelegate* m_pDelegate;
...
#endif /* defined(__OnceAgain__CCScrollviewSimple__) */
